...
class NCLCruiseCatalog {
  ...
  static final norwegianBreakawayWestCaribbean = CruiseProduct(
    ...
    zoomTier: CruiseZoomTier.essential,
  );
  ...
  static final norwegianStarAntarctica = CruiseProduct(
    ...
    zoomTier: CruiseZoomTier.detailed,
  );

  /// All cruise products in the catalog (consolidated)
  static final List<CruiseProduct> allCruises = [
    // Original small catalog
